...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <h3 class="fw-bold text-primary mb-3">{{ Auth::user()->name . ' Actions' }}</h3>
        @if (session('success'))
                ...
                <div class="col-12 col-lg-6">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu w-100">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('actions.index', ['status' => 'pending']) }}">
                                    Pending
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('actions.index', ['status' => 'ongoing']) }}">
                                    On Going
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('actions.index', ['status' => 'completed']) }}">
                                    Completed
                                </a>
                            </li>
                        </ul>
    ...
    <script type="text/javascript" defer>
        ...
        editModal && editModal.addEventListener('hidden.bs.modal', function(event) {
